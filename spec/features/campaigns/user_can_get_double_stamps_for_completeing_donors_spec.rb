  ...
  context 'As a registered user' do
    it 'click on donors choose link and it shows list of campaigns' do
      VCR.use_cassette("features/donors_choose") do
        ...
        within('.campaigns') do
          expect(page).to have_content("Creating a Fun and Comfortable Classroom!")
          expect(page).to have_content("https://www.donorschoose.org/project/creating-a-fun-and-comfortable-classroom/3419522/?utm_source=api&utm_medium=feed&utm_content=bodylink&utm_campaign=DONORSCHOOSE")
