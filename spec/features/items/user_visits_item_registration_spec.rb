...
RSpec.describe 'User visits item#new' do
  context 'user registers a new item' do
    it 'should create item and direct to item show' do
      ...
      expect(current_page).to have_content(biz)
      expect(current_page).to have_content(name)
      expect(current_page).to have_content(amt)
      expect(current_page).to have_content(org)
      expect(current_page).to have_content(org_address)
      expect(current_page).to have_content(category)
    end
  end
end
