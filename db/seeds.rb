...
fb.items.create!(business_name: 'Luna Gourmet Coffee & Tea Company', business_location: '7295 Washington St, Denver, CO 80229', name: 'Brew of Bravery Coffee', donation_amount: '2 bags of coffee', organization: 'USO', organization_location: '8400 Pena Blvd unit 492093, Denver, CO 802494')
...
# product.items.create!(business_name: 'Yuhme', business_location: 'Sundsvall, Sweden', name: 'water bottle', donation_amount: '6 month water supply', organization: "WaterAid", organization_location: 'Central African Republic')
...
# product.items.create!(business_name: 'Nintaanzi', business_location: 'Peru', name: 'necklace', donation_amount: '20% of annual sales', organization: "Homebuilding in Peru", organization_location: 'Peru')
